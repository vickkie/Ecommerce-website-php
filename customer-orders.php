...
echo "<section class='section'>
  ...
  echo "<h3 class='history' style='text-align: center;'>ALL ORDERED PRODUCTS
    ...
    echo "<tr>
      ...
      <td>
        <form method='GET' action='order-tracking.php'>
          ...
          <button type='submit' style='color: skyblue; background: none; border: none;'>Track Order</button>
        </form>
      </td>
    </tr>";
  }
...
<body>
  <div class="containers">
    ...
    <a href="index.php " class="button"><i></i>HOME</a><br>
  </div>
</body>
</html>';
