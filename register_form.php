						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="form-group ">
                                        <div class="text-pad">
                                    <a href="login-form.php" data-toggle="modal" data-target="#Modal_login">Already have an Account ?login here</a>
                                    ...
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="address1" id="address1" placeholder="Town">
                                    </div>
                                    <div class="form-group">
