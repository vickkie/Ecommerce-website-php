...
{				?>	
                      <tr>
                        ...
                        <td>
                          <a href="manage-supplier.php?del=<?php echo $result->supplier_id;?>" onclick="return confirm('Do you want to delete supplier');">
                            <i class="fa fa-trash" style="color:red">
                            </i>
                          </a><br>
                          <a href="manage-supplier.php?unconfirmid=<?php echo $result->supplier_id;?>" onhover="unapprove"   onclick="return confirm('Do you want to unapprove supplier');">
                            <i class="fa fa-times" style="color:green">
                            </i>
                          </a>
