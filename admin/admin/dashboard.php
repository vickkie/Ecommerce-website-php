            ...
            <div class="col-md-12"><center class="pull-right";><img src="product_images/promokings.jpg" /></center>
              ...
              <div class="row">
                <div class="col-md-12">
                 ...
                 <div class="col-md-3">
                      <div class="panel panel-default">
                        <div class="panel-body bk-uzi text-light">
                          <div class="stat-panel text-center">
                        ...
                        ?>
                            ...
                            <div class="stat-panel-title text-uppercase">Unapproved Users
                            </div>
                           <div class="icon">
                        ...
                        <a href="new-user.php" class="block-anchor panel-footer">Full Detail 
                          <i class="fa fa-arrow-right">
                          </i>
                        </a>
                      </div>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-body bk-info text-light">
                          <div class="stat-panel text-center">
                            ...
                            <div class="stat-panel-title text-uppercase">Approved Users
                            </div>
                            <div class="icon">
                 ...
                 <div class="col-md-3">
                      <div class="panel panel-default">
                        ...
                        <a href="manage-customer.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; 
                          <i class="fa fa-arrow-right">
                          </i>
                        </a>
                      </div>
