...
<html lang="en" class="no-js">
  ...
  <ul class="nav nav-tabs bar_tabs " id="myTab" role="tablist">
    ...
    <li class="nav-item">
      <a class="nav-link active" id="contact-tab" href="new-user.php">Unapproved</a>
    </li>
    <li class="nav-item">
...
{				?>	
                      <tr>
                        ...
                        <td>
                          <?php echo htmlentities(strtoupper($result->position));?>
                        </td>
                        <td>
                     ...
                     <td>
                      <a href="assign-position.php?positionid=<?php echo $result->id;?>
                       ">assign position</a>
                         ...
                         <td>
                           <a href="new-user.php?confirmid=<?php echo $result->id;?>" onclick="return confirm('Do you want to Approve user');">
                            <i class="fa fa-check" style="color:blue">
                            </i>
                          </a>
                          <br>
                          <a href="new-user.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to Delete user');">
