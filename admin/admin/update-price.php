...
$sql="UPDATE products SET product_price=(:itemprice) WHERE product_id=(:editid)";
                    ...
                    <div class="panel-body">
                      <form method="post" class="form-horizontal">
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="number" name="itemprice" class="form-control" required placeholder="Per  piece" value="<?php echo htmlentities($resulttemp->product_price); ?>">
                          </div>
                        </div>
                        <div class="form-group">
