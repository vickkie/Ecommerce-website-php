  	...
  	<style type="text/css">
		...
		*{
		...
		.mask {
		  ...
		  mask-image: url(https://i.postimg.cc/Ghgpvnx5/linuxsetting-removebg-preview.png);
		  mask-repeat: no-repeat;
		  -webkit-mask-image: url(https://i.postimg.cc/Ghgpvnx5/linuxsetting-removebg-preview.png);
...
<div class="container">
  <div class="content">
    <h1 class="color-white-shadow text-center">500 Error<br>Internal Server Error</h1>
