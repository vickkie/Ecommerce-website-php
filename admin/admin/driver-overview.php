...
<html lang="en" class="no-js">
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <h2 class="page-title">
                <a href="manage-orders.php">Assigned Orders
                </a>
              </h2>
  ...
  <ul class="nav nav-tabs bar_tabs " id="myTab" role="tablist">
    <li class="nav-item">
      <a class="nav-link" id="profile-tab" href="manage-orders.php">Orders</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" id="contact-tab" href="manage-invoices.php">Invoices</a>
    </li>
        <li class="nav-item">
      <a class="nav-link  active" id="contact-tab" href="driver-overview.php">Delivering</a>
    </li>
  </ul>
</div>
                  ...
                  <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th style="width: 130px;">Order Date
                        </th>
                        <th style="width: 130px;">Name</th>

                        <th style="width: 130px;">Assigned driver
                        </th>
                        
                        <th>Status
                        </th>
                        <th style="width: 60px;">View Order
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 
                      $sql = "SELECT * FROM orders_info WHERE status='Delivering' order by date desc";
                      $query = $dbh -> prepare($sql);
                      $query->execute();
...
$sql2 = "SELECT * FROM assign_driver WHERE order_id = :order_id";
$query1 = $dbh->prepare($sql2);
$query1->bindParam(':order_id', $order_id, PDO::PARAM_INT);
$query1->execute();
$name = $query1->fetch(PDO::FETCH_ASSOC);

if ($name) {
    echo ucwords($name['driver_name']);
}
?>
  ...
  ?>
              ...
              <div><center><?php  echo COMPANY_LOGO ?></center></div>
            </div>
          </div>
        </div>
      </div>
