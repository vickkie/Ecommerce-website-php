            ...
            <div class="col-md-12"><center class="pull-right";><img src="product_images/promokings.jpg" /></center>
              <h2 class="page-title">Dashboard | <?php  echo $position ?>
                    ...
                    <div class="col-md-3">
                      <div class="panel panel-default">
                        ...
                        ?>
                            ...
                            <div class="stat-panel-title text-uppercase">Approved Suppliers
                            </div>
                            <div class="icon">
                        ...
                        <a href="#" class="block-anchor panel-footer text-center">Full Detail &nbsp; 
                  ...
                  <!--   THE SECOND PART-->
                   <div class="col-md-3">
                      <div class="panel panel-default">
                        <div class="panel-body bk-uzi3 text-light">
                          <div class="stat-panel text-center">
                   ...
                   $query->execute();
                    ...
                    ?>
                            ...
                            <div class="stat-panel-title text-uppercase">New Suppliers
                            </div>
                            <div class="icon">
                          <i class="ion  ion-ios-group"></i>
                           </div>
                          </div>
                        </div>
                        <a href="#" class="block-anchor panel-footer text-center">Full Detail &nbsp; 
                          ...
                          <div class="col-md-3">
                          <div class="panel panel-default">
                         <div class="panel-body bk-yellow text-light">
                          <div class="stat-panel text-center">
                    ...
                    <div class="col-md-3">
                      <div class="panel panel-default">
                        <div class="panel-body bk-green text-light">
                          <div class="stat-panel text-center">
                         <?php 
                         $sql1 = "SELECT * FROM products WHERE qty<10";
                         $query1 = $dbh->prepare($sql1);
                         $query1->execute();
                         $results1 = $query1->fetchAll(PDO::FETCH_OBJ);
                        $regbd = $query1->rowCount();
                         ?>
                            ...
                            <div class="stat-panel-title text-uppercase">Products Low Quantity
                            </div><div><i class="ionicons ion-android-textsms"></i></div>
                          </div>
