...
<td>
                        <a href="new-supplier.php?confirmid=<?php echo $result->supplier_id; ?>"  onclick="event.preventDefault();return approve();">
  ...
  .then((willDelete) => {
    if (willDelete) {
      swal("Successfully Approved!", {
        ...
        window.location.href = "new-supplier.php?confirmid=<?php echo $result->supplier_id; ?>";
      });
    } else {
      swal("Aborted!");
    }
...
<br>
                          <a href="new-supplier.php?del=<?php echo $result->supplier_id;?>" onclick="event.preventDefault(); return willDelete();">
                      <script>
...
.then((willDelete) => {
  if (willDelete) {
    swal("Poof! User have been deleted!", {
      icon: "success",
    }).then(() => {
        window.location.href = "new-supplier.php?del=<?php echo $result->supplier_id; ?>";
      });
  } else {
    swal("Aborted!");
  }
