...
$allowedPositions = array('human resource', 'super admin' ,'admin');
...
{				?>	
  ...
  ?>
                         ...
                         <td>
                          <a href="manage-user.php?del=<?php echo $result->id;?>" onclick="event.preventDefault(); return willDelete();">
                      <script>
  ...
  if (willDelete) {
    swal("Poof! User have been deleted!", {
      icon: "success",
        ...
        window.location.href = "manage-user.php?del=<?php echo $result->id; ?>";
      });
  } else {
    swal("Aborted!");
  }
...
<br>
                           <a href="manage-user.php?unconfirmid=<?php echo $result->id; ?>"  onclick="event.preventDefault(); return unapprove();">
  ...
  .then((willDelete) => {
    if (willDelete) {
      swal("Successfully Unapproved!", {
        ...
        window.location.href ="manage-user.php?unconfirmid=<?php echo $result->id; ?>";
      });
    } else {
      swal("Aborted!");
    }
