...
$allowedPositions = array('inventory manager','sales manager', 'super admin' ,'admin');
...
$query -> execute();
$sql2 = "insert into deleteduser (email) values (:email)";
$query2 = $dbh->prepare($sql2);
$query2 -> bindParam(':email',$name, PDO::PARAM_STR);
$query2 -> execute();
...
$query -> execute();
//$msg="Supplier Unapproved Sucessfully";
}
if(isset($_REQUEST['confirm']))
{
$aeid=intval($_GET['confirm']);
$memstatus=0;
$sql = "UPDATE suppliers SET status=:status WHERE  id=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$memstatus, PDO::PARAM_STR);
$query-> bindParam(':aeid',$aeid, PDO::PARAM_STR);
$query -> execute();
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php $sql = "SELECT * from  suppliers WHERE status='Approved'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{       ?>  
                      <tr>
                        ...
                        <td>
                                  ...
                                  <a href="manage-supplier.php?unconfirmid=<?php echo ($result->supplier_id); ?>"  onclick="event.preventDefault();return unapprove();">
                      ...
                      <script>
                       ...
                       function unapprove() {
                         ...
                         dangerMode: true,
                          ...
                          .then((willDelete) => {
                          if (willDelete) {
                          swal("Successfully Unapproved!", {
                          icon: "success",
                          }).then(() => {
                          window.location.href = 
                          "manage-supplier.php?unconfirmid=<?php echo $result->supplier_id; ?>";
                           });
                          } else {
                          swal("Aborted!");
                           }
...
<br>
                ...
                <a href="manage-supplier.php?del=<?php echo $result->supplier_id;?>" onclick="event.preventDefault();return willDelete();">
                ...
                .then((willDelete) => {
               if (willDelete) {
                swal("Poof! Supplier have been deleted!", {
               icon: "success",
               }).then(() => {
               window.location.href = 
               "manage-supplier.php?del=<?php echo $result->supplier_id; ?>";
                });
                } else {
               swal("Aborted!");
               }
