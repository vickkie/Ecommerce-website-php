			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<!-- store bottom filter -->
						<div class="store-filter clearfix">
							<span class="store-qty">Showing 10-100 products</span>
