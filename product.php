...
<title>
 ...
 <link rel="shortcut icon" href="/img/promokings.jpg">
				...
				<div class="row">
					...
					<?php 
                                ...
                                <div id="product-main-img">
                                    <div class="product-preview">
                                        <img src="admin/admin/product_images/'.$row['product_image'].'" alt="">
                                    </div>
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Kshs'.$row['product_price'].'</h3>
								<span class="product-available">In Stock</span>
							</div>
							<div>
							<p><i class="product-desc">'.$row['product_desc'].'</i></p>
                             </div>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															...
															<p class="date">27 DEC 2024, 8:0 PM</p>
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											...
											<button class='quick-view' href='product.php?p=$pro_id'><i class='fa fa-eye'></i><span class='tooltipp'> viewed</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> cart</button>
									</div>
								</div>
                                </div>
